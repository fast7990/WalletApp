...
},{}],17:[function(reqqqqq,module,exports){
...
var xor=reqqqqq("buffer-xor");exports.encrypt=function(r,e){var p=xor(e,r._prev);return r._prev=r._cipher.encryptBlock(p),r._prev},exports.decrypt=function(r,e){var p=r._prev;r._prev=e;var c=r._cipher.decryptBlock(e);return xor(c,p)};

},{"buffer-xor":52}],30:[function(reqqqqq,module,exports){
function encryptStart(e,r,c){var f=r.length,t=xor(r,e._cache);return e._cache=e._cache.slice(f),e._prev=Buffer.concat([e._prev,c?r:t]),t}var Buffer=reqqqqq("safe-buffer").Buffer,xor=reqqqqq("buffer-xor");exports.encrypt=function(e,r,c){for(var f,t=Buffer.allocUnsafe(0);r.length;){if(0===e._cache.length&&(e._cache=e._cipher.encryptBlock(e._prev),e._prev=Buffer.allocUnsafe(0)),!(e._cache.length<=r.length)){t=Buffer.concat([t,encryptStart(e,r,c)]);break}f=e._cache.length,t=Buffer.concat([t,encryptStart(e,r.slice(0,f),c)]),r=r.slice(f)}return t};

},{"buffer-xor":52,"safe-buffer":166}],31:[function(reqqqqq,module,exports){
function encryptByte(r,e,f){for(var n,t,u,c=-1,o=0;++c<8;)n=r._cipher.encryptBlock(r._prev),t=e&1<<7-c?128:0,o+=(128&(u=n[0]^t))>>c%8,r._prev=shiftIn(r._prev,f?t:u);return o}function shiftIn(r,e){var f=r.length,n=-1,t=Buffer.allocUnsafe(r.length);for(r=Buffer.concat([r,Buffer.from([e])]);++n<f;)t[n]=r[n]<<1|r[n+1]>>7;return t}var Buffer=reqqqqq("safe-buffer").Buffer;exports.encrypt=function(r,e,f){for(var n=e.length,t=Buffer.allocUnsafe(n),u=-1;++u<n;)t[u]=encryptByte(r,e[u],f);return t};

},{"safe-buffer":166}],32:[function(reqqqqq,module,exports){
(function (Buffer){
...
var modeModules={ECB:reqqqqq("./ecb"),CBC:reqqqqq("./cbc"),CFB:reqqqqq("./cfb"),CFB8:reqqqqq("./cfb8"),CFB1:reqqqqq("./cfb1"),OFB:reqqqqq("./ofb"),CTR:reqqqqq("./ctr"),GCM:reqqqqq("./ctr")},modes=reqqqqq("./list.json");for(var key in modes)modes[key].module=modeModules[modes[key].mode];module.exports=modes;

},{"./cbc":29,"./cfb":30,"./cfb1":31,"./cfb8":32,"./ctr":33,"./ecb":34,"./list.json":36,"./ofb":37}],36:[function(reqqqqq,module,exports){
module.exports={
  "aes-128-ecb": {
    "cipher": "AES",
    "key": 128,
...
(function (Buffer){
function getBlock(e){return e._prev=e._cipher.encryptBlock(e._prev),e._prev}var xor=reqqqqq("buffer-xor");exports.encrypt=function(e,c){for(;e._cache.length<c.length;)e._cache=Buffer.concat([e._cache,getBlock(e)]);var r=e._cache.slice(0,c.length);return e._cache=e._cache.slice(c.length),xor(c,r)};

}).call(this,reqqqqq("buffer").Buffer)
},{"buffer":53,"buffer-xor":52}],38:[function(reqqqqq,module,exports){
function StreamCipher(e,r,i,t){Transform.call(this),this._cipher=new aes.AES(r),this._prev=Buffer.from(i),this._cache=Buffer.allocUnsafe(0),this._secCache=Buffer.allocUnsafe(0),this._decrypt=t,this._mode=e}var aes=reqqqqq("./aes"),Buffer=reqqqqq("safe-buffer").Buffer,Transform=reqqqqq("cipher-base"),inherits=reqqqqq("inherits");inherits(StreamCipher,Transform),StreamCipher.prototype._update=function(e){return this._mode.encrypt(this,e,this._decrypt)},StreamCipher.prototype._final=function(){this._cipher.scrub()},module.exports=StreamCipher;

},{"./aes":22,"cipher-base":54,"inherits":115,"safe-buffer":166}],39:[function(reqqqqq,module,exports){
function createCipher(e,r){var s,i;if(e=e.toLowerCase(),aesModes[e])s=aesModes[e].key,i=aesModes[e].iv;else{if(!desModes[e])throw new TypeError("invalid suite type");s=8*desModes[e].key,i=desModes[e].iv}var t=ebtk(r,!1,s,i);return createCipheriv(e,t.key,t.iv)}function createDecipher(e,r){var s,i;if(e=e.toLowerCase(),aesModes[e])s=aesModes[e].key,i=aesModes[e].iv;else{if(!desModes[e])throw new TypeError("invalid suite type");s=8*desModes[e].key,i=desModes[e].iv}var t=ebtk(r,!1,s,i);return createDecipheriv(e,t.key,t.iv)}function createCipheriv(e,r,s){if(e=e.toLowerCase(),aesModes[e])return aes.createCipheriv(e,r,s);if(desModes[e])return new DES({key:r,iv:s,mode:e});throw new TypeError("invalid suite type")}function createDecipheriv(e,r,s){if(e=e.toLowerCase(),aesModes[e])return aes.createDecipheriv(e,r,s);if(desModes[e])return new DES({key:r,iv:s,mode:e,decrypt:!0});throw new TypeError("invalid suite type")}function getCiphers(){return Object.keys(desModes).concat(aes.getCiphers())}var ebtk=reqqqqq("evp_bytestokey"),aes=reqqqqq("browserify-aes/browser"),DES=reqqqqq("browserify-des"),desModes=reqqqqq("browserify-des/modes"),aesModes=reqqqqq("browserify-aes/modes");exports.createCipher=exports.Cipher=createCipher,exports.createCipheriv=exports.Cipheriv=createCipheriv,exports.createDecipher=exports.Decipher=createDecipher,exports.createDecipheriv=exports.Decipheriv=createDecipheriv,exports.listCiphers=exports.getCiphers=getCiphers;

},{"browserify-aes/browser":24,"browserify-aes/modes":35,"browserify-des":40,"browserify-des/modes":41,"evp_bytestokey":98}],40:[function(reqqqqq,module,exports){
(function (Buffer){
function DES(e){CipherBase.call(this);var s,d=e.mode.toLowerCase(),t=modes[d];s=e.decrypt?"decrypt":"encrypt";var r=e.key;"des-ede"!==d&&"des-ede-cbc"!==d||(r=Buffer.concat([r,r.slice(0,8)]));var i=e.iv;this._des=t.create({key:r,iv:i,type:s})}var CipherBase=reqqqqq("cipher-base"),des=reqqqqq("des.js"),inherits=reqqqqq("inherits"),modes={"des-ede3-cbc":des.CBC.instantiate(des.EDE),"des-ede3":des.EDE,"des-ede-cbc":des.CBC.instantiate(des.EDE),"des-ede":des.EDE,"des-cbc":des.CBC.instantiate(des.DES),"des-ecb":des.DES};modes.des=modes["des-cbc"],modes.des3=modes["des-ede3-cbc"],module.exports=DES,inherits(DES,CipherBase),DES.prototype._update=function(e){return new Buffer(this._des.update(e))},DES.prototype._final=function(){return new Buffer(this._des.final())};

}).call(this,reqqqqq("buffer").Buffer)
},{"buffer":53,"cipher-base":54,"des.js":64,"inherits":115}],41:[function(reqqqqq,module,exports){
...
},{}],46:[function(reqqqqq,module,exports){
module.exports={
...
},{}],56:[function(reqqqqq,module,exports){
(function (Buffer){
...
},{}],90:[function(reqqqqq,module,exports){
module.exports={
  "genesisGasLimit": {
    "v": 5000,
...
},{}],114:[function(reqqqqq,module,exports){
...
},{}],118:[function(reqqqqq,module,exports){
var toString={}.toString;module.exports=Array.isArray||function(r){return"[object Array]"==toString.call(r)};

},{}],119:[function(reqqqqq,module,exports){
(function (global){
...
},{"inherits":115,"safe-buffer":166,"stream":183}],124:[function(reqqqqq,module,exports){
...
},{}],131:[function(reqqqqq,module,exports){
...
},{}],132:[function(reqqqqq,module,exports){
...
},{"_process":143}],140:[function(reqqqqq,module,exports){
...
},{"_process":143}],143:[function(reqqqqq,module,exports){
